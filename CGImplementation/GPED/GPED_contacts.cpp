...
void GPED::ContactResolver::resolveContacts(Contact * contacts, unsigned numContacts, real duration)
{
...
void GPED::ContactResolver::prepareContacts(Contact * contacts, unsigned numContacts, real duration)
{
...
void GPED::ContactResolver::adjustVelocities(Contact * c, unsigned numContacts, real duration)
{
...
void GPED::ContactResolver::adjustPositions(Contact * c, unsigned numContacts, real duration)
{
	unsigned i, index;
