#ifndef __GPED_PLINKS_H__
#define __GPED_PLINKS_H__

#include <GPED/GPED_Pcontacts.h>

namespace GPED
{
	/**
	 * Links connect two particlestogether, generating a contact if
	...
	/**
	 * Cables linke a pair of particles, generating a contact if they
	 * stray too far apart.
	 */
